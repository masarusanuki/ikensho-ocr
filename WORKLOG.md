...
- 期間: 2026-09-06 07:03 〜 2026-09-11 14:07
- コミット 46 件 / 追加 37,669 行 / 削除 5,203 行

### 今のコード量（コメント・空行を含む行数）

| 置き場所 | ファイル | 行 |
|---|---:|---:|
| ブラウザ版（確認・編集画面） | 21 | 7,746 |
| Python版（読み取り本体） | 24 | 5,464 |
| 生成・検証スクリプト | 30 | 6,113 |
...
| 置き場所 | 追加 | 削除 | 触ったファイル |
|---|---:|---:|---:|
| ブラウザ版（確認・編集画面） | 8,373 | 519 | 28 |
| 様式テンプレート | 6,694 | 769 | 11 |
| 生成・検証スクリプト | 6,376 | 293 | 30 |
| Python版（読み取り本体） | 5,869 | 400 | 25 |
| その他（README・設定など） | 5,722 | 3,065 | 23 |
| 辞書 | 2,039 | 32 | 9 |
| 項目定義 | 1,227 | 82 | 1 |
| 説明書 | 937 | 37 | 12 |
