...
- 期間: 2026-09-06 07:03 〜 2026-09-23 16:19
- コミット 84 件 / 追加 48,138 行 / 削除 5,584 行

### 今のコード量（コメント・空行を含む行数）

| 置き場所 | ファイル | 行 |
|---|---:|---:|
| ブラウザ版（確認・編集画面） | 22 | 8,544 |
| Python版（読み取り本体） | 29 | 7,719 |
| 生成・検証スクリプト | 42 | 8,377 |
...
| ブラウザ版（確認・編集画面） | 9,239 | 588 | 29 |
| 生成・検証スクリプト | 8,702 | 331 | 43 |
| Python版（読み取り本体） | 8,284 | 565 | 30 |
| その他（README・設定など） | 7,325 | 3,160 | 24 |
| 辞書 | 2,039 | 32 | 9 |
| 説明書 | 1,300 | 51 | 12 |
| 項目定義 | 1,259 | 82 | 1 |
