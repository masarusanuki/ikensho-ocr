...
- 期間: 2026-09-06 07:03 〜 2026-09-08 21:25
- コミット 41 件 / 追加 33,915 行 / 削除 5,097 行

### 今のコード量（コメント・空行を含む行数）

| 置き場所 | ファイル | 行 |
|---|---:|---:|
| ブラウザ版（確認・編集画面） | 20 | 6,425 |
| Python版（読み取り本体） | 22 | 4,350 |
| 生成・検証スクリプト | 27 | 5,316 |
...
| 置き場所 | 追加 | 削除 | 触ったファイル |
|---|---:|---:|---:|
| ブラウザ版（確認・編集画面） | 6,998 | 464 | 27 |
| 様式テンプレート | 6,694 | 769 | 11 |
| 生成・検証スクリプト | 5,577 | 288 | 27 |
| その他（README・設定など） | 5,315 | 3,054 | 23 |
| Python版（読み取り本体） | 4,722 | 365 | 23 |
| 辞書 | 2,039 | 32 | 9 |
| 項目定義 | 1,227 | 82 | 1 |
| 説明書 | 911 | 37 | 12 |
