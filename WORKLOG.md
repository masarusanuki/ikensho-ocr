...
- 期間: 2026-09-06 07:03 〜 2026-09-23 07:37
- コミット 80 件 / 追加 46,336 行 / 削除 5,502 行

### 今のコード量（コメント・空行を含む行数）

| 置き場所 | ファイル | 行 |
|---|---:|---:|
| ブラウザ版（確認・編集画面） | 21 | 8,237 |
| Python版（読み取り本体） | 28 | 7,182 |
| 生成・検証スクリプト | 39 | 7,901 |
...
| ブラウザ版（確認・編集画面） | 8,921 | 576 | 28 |
| 生成・検証スクリプト | 8,229 | 331 | 40 |
| Python版（読み取り本体） | 7,711 | 528 | 29 |
| その他（README・設定など） | 6,958 | 3,130 | 23 |
| 辞書 | 2,039 | 32 | 9 |
| 説明書 | 1,261 | 48 | 12 |
| 項目定義 | 1,227 | 82 | 1 |
