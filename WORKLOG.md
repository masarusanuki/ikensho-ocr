...
| **検証用サンプル2（1,000通）で検証** | ✅ | `seigo2_v1` を追加。チェック 85.10% / 文字 70.71%（開発メモ 7.7、ISSUE #62） |
...
- 期間: 2026-09-06 07:03 〜 2026-09-12 13:35
- コミット 72 件 / 追加 40,704 行 / 削除 5,433 行
...
| 生成・検証スクリプト | 6,849 | 322 | 33 |
| Python版（読み取り本体） | 6,800 | 505 | 26 |
| 様式テンプレート | 6,694 | 769 | 11 |
| その他（README・設定など） | 6,536 | 3,096 | 23 |
| 辞書 | 2,039 | 32 | 9 |
| 説明書 | 1,229 | 48 | 12 |
| 項目定義 | 1,227 | 82 | 1 |
