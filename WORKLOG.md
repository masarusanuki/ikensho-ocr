...
- 期間: 2026-09-06 07:03 〜 2026-09-23 08:22
- コミット 82 件 / 追加 47,257 行 / 削除 5,534 行

### 今のコード量（コメント・空行を含む行数）

| 置き場所 | ファイル | 行 |
|---|---:|---:|
| ブラウザ版（確認・編集画面） | 22 | 8,493 |
| Python版（読み取り本体） | 29 | 7,496 |
| 生成・検証スクリプト | 40 | 7,972 |
...
| ブラウザ版（確認・編集画面） | 9,184 | 584 | 29 |
| 生成・検証スクリプト | 8,299 | 331 | 41 |
| Python版（読み取り本体） | 8,031 | 535 | 30 |
| その他（README・設定など） | 7,155 | 3,144 | 23 |
| 辞書 | 2,039 | 32 | 9 |
| 説明書 | 1,300 | 51 | 12 |
| 項目定義 | 1,259 | 82 | 1 |
